...
- `ffmpeg-static` distribuye un binario de FFmpeg bajo GPL-3.0-or-later. El código fuente correspondiente y la información de compilación están disponibles desde el proyecto `ffmpeg-static` y FFmpeg.
