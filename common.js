...
'settings.background.error': 'Error al aplicar el fondo',
    ...
    'settings.discord.on': 'Mostrando estado en Discord',
    'settings.discord.off': 'No se muestra nada en Discord',
    'settings.discord.connected': 'Conectado a Discord',
    'settings.discord.notConnected': 'Sin conexión con Discord (¿está abierto?)',
    'settings.discord.unconfigured': 'Falta configurar el Client ID',
    ...
    'instance.settings.open': 'Ajustes de la instancia',
    'instance.settings.tab.general': 'General',
    'instance.settings.tab.installation': 'Instalación',
    'instance.settings.tab.java': 'Java',
    'instance.settings.icon': 'Ícono',
    'instance.settings.duplicate': 'Duplicar instancia',
    'instance.settings.duplicateDesc': 'Crea una copia con sus mods, configs y mundos.',
    'instance.settings.duplicateBtn': 'Duplicar',
    'instance.settings.duplicateOk': 'Instancia duplicada: {name}',
    'instance.settings.updateChannel': 'Canal de updates',
    'instance.settings.updateChannelReleaseDesc': 'Solo versiones release.',
    'instance.settings.updateChannelBetaDesc': 'Versiones release y beta.',
    'instance.settings.updateChannelAlphaDesc': 'Versiones release, beta y alpha.',
    'instance.settings.delete': 'Eliminar instancia',
    'instance.settings.deleteDesc': 'Borra la instancia con sus mundos, configs y contenido. No se puede deshacer.',
    'instance.settings.deletePlaceholder': 'Escribí el nombre de la instancia',
    'instance.settings.deleteBtn': 'Eliminar',
    'instance.settings.current': 'Instalación actual',
    'instance.settings.changeVersion': 'Cambiar versión',
    'instance.settings.changeVersionDesc': 'Se reinstala el perfil al jugar. Tus mundos y configs se conservan.',
    'instance.settings.applyVersion': 'Aplicar y reinstalar',
    'instance.settings.versionApplied': 'Versión actualizada. Se reinstalará al jugar.',
    'instance.settings.modpack': 'Modpack vinculado',
    'instance.settings.unlinkModpack': 'Desvincular',
    'instance.settings.unlinked': 'Modpack desvinculado.',
    'instance.settings.repair': 'Reparar instalación',
    'instance.settings.repairDesc': 'Borra el perfil generado y lo vuelve a instalar. Tus mundos y configs se conservan.',
    'instance.settings.repairBtn': 'Reparar',
    'instance.settings.repaired': 'Perfil borrado. Se reinstalará al jugar.',
    'instance.settings.memory': 'Memoria (RAM)',
    'instance.settings.memoryDesc': 'Vacío = usar la global de Ajustes.',
    'instance.settings.memoryError': 'RAM inválida: usá números 512-32768 y mínima menor que máxima.',
    'instance.settings.javaHome': 'Java de esta instancia',
    'instance.settings.javaHomeDesc': 'Vacío = automático según la versión.',
    'instance.settings.jvmArgs': 'Argumentos JVM extra',
    'instance.settings.jvmArgsDesc': 'Vacío = usar los globales. Separados por espacio.',
    'instance.settings.saveJava': 'Guardar Java',
    'instance.settings.saved': 'Ajustes guardados.',
...
'instances.importInvalid': 'Archivo .mrpack inválido',
    ...
    'install.destination.downloads': 'Descargar local',
    'install.destination.instance': 'Instalación del launcher',
    'install.destination.newInstance': 'Nueva instancia',
    'install.destination.downloadsShort': 'Descargar local',
    'install.localPath': 'Ruta',
    'install.localPath.placeholder': 'Carpeta de descarga',
    'install.browse': 'Examinar…',
    'install.pickFolder': 'Elegir carpeta de descarga',
    ...
    'create.choice.title': '¿Cómo querés empezar?',
    'create.choice.modpack': 'Comenzar con un modpack',
    'create.choice.modpackDesc': 'Un pack listo para jugar, desde Modrinth o un archivo .mrpack',
    'create.choice.custom': 'Personalizado',
    'create.choice.customDesc': 'Elegí loader y versión de Minecraft',
    'create.choice.search': 'Buscar modpacks',
    'create.choice.searchDesc': 'Desde Modrinth, listo para instalar',
    'create.choice.importFile': 'Importar archivo .mrpack',
    'create.choice.importFileDesc': 'Ya tenés el archivo descargado',
    'create.back': 'Volver',
    'create.name': 'Nombre',
    'create.gameVersion': 'Versión del juego',
    'create.loaderVersion': 'Versión del loader',
    'create.channel.stable': 'Estable',
    'create.channel.latest': 'Más Reciente',
    'create.channel.other': 'Otro',
    'create.channel.release': 'Release',
    'create.channel.beta': 'Beta',
    'create.channel.alpha': 'Alpha',
    'create.otherPlaceholder': '0.16.9',
    'create.badLoaderVersion': 'Escribí la versión del loader',
    'create.icon.upload': 'Subir',
    'create.icon.random': 'Aleatorizar',
    'create.icon.customize': 'Personalizar',
    'create.icon.browseError': 'No se pudo elegir el ícono',
...
'settings.background.error': 'Error applying background',
    ...
    'instance.settings.tab.general': 'General',
    'instance.settings.tab.installation': 'Installation',
    'instance.settings.tab.java': 'Java',
    'instance.settings.icon': 'Icon',
    'instance.settings.duplicate': 'Duplicate instance',
    'instance.settings.duplicateDesc': 'Creates a copy with its mods, configs and worlds.',
    'instance.settings.duplicateBtn': 'Duplicate',
    'instance.settings.duplicateOk': 'Instance duplicated: {name}',
    'instance.settings.updateChannel': 'Update channel',
    'instance.settings.updateChannelReleaseDesc': 'Release versions only.',
    'instance.settings.updateChannelBetaDesc': 'Release and beta versions.',
    'instance.settings.updateChannelAlphaDesc': 'Release, beta and alpha versions.',
    'instance.settings.delete': 'Delete instance',
    'instance.settings.deleteDesc': 'Deletes the instance with its worlds, configs and content. Cannot be undone.',
    'instance.settings.deletePlaceholder': 'Type the instance name',
    'instance.settings.deleteBtn': 'Delete',
    'instance.settings.current': 'Current installation',
    'instance.settings.changeVersion': 'Change version',
    'instance.settings.changeVersionDesc': 'The profile reinstalls on play. Your worlds and configs are kept.',
    'instance.settings.applyVersion': 'Apply and reinstall',
    'instance.settings.versionApplied': 'Version updated. It will reinstall on play.',
    'instance.settings.modpack': 'Linked modpack',
    'instance.settings.unlinkModpack': 'Unlink',
    'instance.settings.unlinked': 'Modpack unlinked.',
    'instance.settings.repair': 'Repair installation',
    'instance.settings.repairDesc': 'Deletes the generated profile and reinstalls it. Your worlds and configs are kept.',
    'instance.settings.repairBtn': 'Repair',
    'instance.settings.repaired': 'Profile deleted. It will reinstall on play.',
    'instance.settings.memory': 'Memory (RAM)',
    'instance.settings.memoryDesc': 'Empty = use the global Settings value.',
    'instance.settings.memoryError': 'Invalid RAM: use numbers 512-32768 with min lower than max.',
    'instance.settings.javaHome': 'This instance Java',
    'instance.settings.javaHomeDesc': 'Empty = automatic for the version.',
    'instance.settings.jvmArgs': 'Extra JVM arguments',
    'instance.settings.jvmArgsDesc': 'Empty = use the global ones. Space separated.',
    'instance.settings.saveJava': 'Save Java',
    'instance.settings.saved': 'Settings saved.',
...
'instance.showLess': 'Show less',
    ...
    'settings.discord.on': 'Showing status on Discord',
    'settings.discord.off': 'Nothing is shown on Discord',
    'settings.discord.connected': 'Connected to Discord',
    'settings.discord.notConnected': 'Not connected to Discord (is it open?)',
    'settings.discord.unconfigured': 'Client ID not configured',
...
'instances.importInvalid': 'Invalid .mrpack file',
    ...
    'install.destination.downloads': 'Download locally',
    'install.destination.instance': 'Launcher installation',
    'install.destination.newInstance': 'New instance',
    'install.destination.downloadsShort': 'Download locally',
    'install.localPath': 'Path',
    'install.localPath.placeholder': 'Download folder',
    'install.browse': 'Browse…',
    'install.pickFolder': 'Choose download folder',
    ...
    'create.choice.title': 'How do you want to start?',
    'create.choice.modpack': 'Start with a modpack',
    'create.choice.modpackDesc': 'A ready-to-play pack, from Modrinth or an .mrpack file',
    'create.choice.custom': 'Custom',
    'create.choice.customDesc': 'Choose loader and Minecraft version',
    'create.choice.search': 'Browse modpacks',
    'create.choice.searchDesc': 'From Modrinth, ready to install',
    'create.choice.importFile': 'Import .mrpack file',
    'create.choice.importFileDesc': 'You already have the file downloaded',
    'create.back': 'Back',
    'create.name': 'Name',
    'create.gameVersion': 'Game version',
    'create.loaderVersion': 'Loader version',
    'create.channel.stable': 'Stable',
    'create.channel.latest': 'Latest',
    'create.channel.other': 'Other',
    'create.channel.release': 'Release',
    'create.channel.beta': 'Beta',
    'create.channel.alpha': 'Alpha',
    'create.otherPlaceholder': '0.16.9',
    'create.badLoaderVersion': 'Type the loader version',
    'create.icon.upload': 'Upload',
    'create.icon.random': 'Randomize',
    'create.icon.customize': 'Customize',
    'create.icon.browseError': 'Could not pick the icon',
...
try {
  ...
  settings.discordRPC = saved.discordRPC === undefined ? true : Boolean(saved.discordRPC)
  ...
  applyLanguage()
  try {
    if (window.kindyrAPI?.discord?.setEnabled) {
      window.kindyrAPI.discord.setEnabled(settings.discordRPC !== false).catch(() => {})
    }
  } catch {}
}
