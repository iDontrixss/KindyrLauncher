...
contextBridge.exposeInMainWorld('kindyrAPI', {
  ...
  instances: {
    ...
    loaderVersions: (payload) => ipcRenderer.invoke('loader-versions', payload),
    browseIcon: () => ipcRenderer.invoke('browse-instance-icon'),
    rename: (payload) => ipcRenderer.invoke('instance-rename', payload),
    duplicate: (payload) => ipcRenderer.invoke('instance-duplicate', payload),
    remove: (payload) => ipcRenderer.invoke('instance-delete', payload),
    setIcon: (payload) => ipcRenderer.invoke('instance-set-icon', payload),
    setChannel: (payload) => ipcRenderer.invoke('instance-set-channel', payload),
    setLaunchOpts: (payload) => ipcRenderer.invoke('instance-set-launch-opts', payload),
    changeVersion: (payload) => ipcRenderer.invoke('instance-change-version', payload),
    repair: (payload) => ipcRenderer.invoke('instance-repair', payload),
    unlinkModpack: (payload) => ipcRenderer.invoke('instance-unlink-modpack', payload),
  ...
  microsoft: {
   ...
   discord: {
     ...
     getState: () => ipcRenderer.invoke('discord-get-state'),
     setActivity: (state, info) => ipcRenderer.invoke('discord-set-activity', { state, info })
   },
  onboarding: {
